...
class SimplePhotographySection extends StatefulWidget {
  const SimplePhotographySection({super.key});

  @override
  State<SimplePhotographySection> createState() => _SimplePhotographySectionState();
}

class _SimplePhotographySectionState extends State<SimplePhotographySection> {
  ...
  Widget build(BuildContext context) {
    print('Building SimplePhotographySection');
