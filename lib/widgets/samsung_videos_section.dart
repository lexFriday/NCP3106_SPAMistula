...
class SamsungVideosSection extends StatefulWidget {
  const SamsungVideosSection({super.key});

  @override
  State<SamsungVideosSection> createState() => _SamsungVideosSectionState();
}

class _SamsungVideosSectionState extends State<SamsungVideosSection> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _videoController.repeat(reverse: true);
    _loadVideos();
  }
  ...
  Future<void> _loadVideos() async {
    try {
      ...
      final posts = await YouTubeApiService.fetchPlaylistItems(
        ...
        maxResults: 10, // Limit for better performance
      );
      setState(() {
        _videos = posts;
        _isLoading = false;
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return Stack(
                children: [
                  Positioned(
                    top: 60 + (_videoAnimation.value * 45),
                    right: 50,
                    child: _buildFloatingElement(Icons.play_circle_outline, const Color(0xFFFF0000), 0.3),
                  ),
                  Positioned(
                    top: 250 + (_videoAnimation.value * -35),
                    left: 25,
                    child: _buildFloatingElement(Icons.video_camera_front_outlined, Colors.black, 0.25),
                  ),
                  Positioned(
                    bottom: 120 + (_videoAnimation.value * 40),
                    right: 80,
                    child: _buildFloatingElement(Icons.music_note_outlined, const Color(0xFFFF0000), 0.2),
                  ),
                ],
              );
            },
          ...
          Container(
            ...
            child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius:
                            BorderRadius.circular(SamsungOneUITheme.radiusL),
                      ),
                      child: Icon(
              ...
              // Videos Content with Larger Portrait Layout
          if (_isLoading)
            Container(
              height: 600,
              decoration: SamsungOneUITheme.cardDecoration(context),
              child: Center(
                child: Column(
            ...
            Column(
              children: [
                ...
                Container(
                  height:
                      isMobile ? 500 : 700, // Much larger for portrait videos
                  decoration: SamsungOneUITheme.cardDecoration(context),
                  child: Column(
                    children: [
                      // Video Display
                      Expanded(
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return _buildPortraitVideoCard(
                                context, _videos[index], isMobile);
                          },
                        ),
                      ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: const BorderRadius.only(
                            bottomLeft:
                                Radius.circular(SamsungOneUITheme.radiusM),
                            bottomRight:
                                Radius.circular(SamsungOneUITheme.radiusM),
                          ),
                        ),
  ...
  Widget _buildPortraitVideoCard(
      BuildContext context, InstagramPost video, bool isMobile) {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // Video Thumbnail - Optimized for portrait
            Positioned.fill(
              child: Image.network(
                video.thumbnailUrl,
                fit: BoxFit.cover,
            ...
            // Video Info with Creative Design
            Positioned(
              bottom: 0,
              left: 0,
              right: 0,
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius:
                      BorderRadius.circular(SamsungOneUITheme.radiusS),
                ),
                child: Icon(
